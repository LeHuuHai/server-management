...
func (_m *MockPublisher) Publish(ctx context.Context, msg mq.Message) error {
...
func (_c *MockPublisher_Publish_Call) Run(run func(ctx context.Context, msg mq.Message)) *MockPublisher_Publish_Call {
...
func (_c *MockPublisher_Publish_Call) RunAndReturn(run func(context.Context, mq.Message) error) *MockPublisher_Publish_Call {
	_c.Call.Return(run)
	return _c
}
